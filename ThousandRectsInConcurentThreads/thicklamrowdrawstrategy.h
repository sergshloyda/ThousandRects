...
private:
	...
	void PlotLamThick(QPainter & painter, const std::vector<ElementInfo*>& vec, QPen &pen1, QPen &pen2,const float pixmap_height,const float pixmap_width,const float plot_step_x);
